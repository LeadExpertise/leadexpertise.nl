        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="bg-white text-[#0071eb] hover:bg-blue-50 font-semibold rounded-full px-6 py-3.5 h-auto card-floating group">
                <span>Doe advertentie winstgevendheid quiz</span>
                <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-0.5" />
              </Button>
              <Button variant="outline" className="bg-transparent text-white border-white/20 hover:bg-white/10 hover:border-white/40 font-semibold rounded-full px-6 py-3.5 h-auto">
                Lees meer over de tevredenheidsgarantie
              </Button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-10 card-dramatic relative overflow-hidden">
            <form className="flex flex-col gap-5 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="website" className="text-sm font-semibold text-slate-900">Wat is de URL van je website?</label>
                  <input 
                    type="url" 
                    id="website" 
              ...
              {/* Max Cost Input */}
              <div className="flex flex-col gap-2">
                <label htmlFor="max_cost" className="text-sm font-semibold text-slate-900">
